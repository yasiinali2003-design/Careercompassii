...
export const categories: Record<string, CategoryInfo> = {
  luova: {
    ...
    name_fi: "Luova",
    name_en: "Creative",
    description: "Taiteilijat, suunnittelijat, sisällöntuottajat",
  ...
  johtaja: {
    ...
    name_fi: "Johtaja",
    name_en: "Leader",
    description: "Yrittäjät, managerit, vaikuttajat",
  ...
  innovoija: {
    ...
    name_fi: "Innovoija",
    name_en: "Innovator",
    description: "Tech-rakentajat, ongelmanratkaisijat",
  ...
  rakentaja: {
    ...
    name_fi: "Rakentaja",
    name_en: "Builder",
    description: "Käytännön tekijät, käsityöläiset",
  ...
  auttaja: {
    ...
    name_fi: "Auttaja",
    name_en: "Helper",
    description: "Hoitajat, opettajat, puolustajat",
  ...
  "ympariston-puolustaja": {
    ...
    description: "Vihreät ajattelijat, kestävän kehityksen tekijät",
  ...
  visionaari: {
    ...
    name_fi: "Visionääri",
    name_en: "Visionary",
    description: "Tulevaisuuden näkijät, strategit",
  ...
  jarjestaja: {
    ...
    name_fi: "Järjestäjä",
    name_en: "Organizer",
    description: "Koordinaattorit, projektipäälliköt",
