...
export function generateUserProfile(
  ...
  // NOTE: personalizedAnalysis is now generated by the CALLER who has career context
  // This ensures the analysis text aligns with the actual recommended careers
  // The caller should call generateEnhancedPersonalizedAnalysis(answers, userProfile, cohort, careers)
  // and append edge case message if needed
