...
exports.COHORT_WEIGHTS = exports.QUESTION_MAPPINGS = void 0;
exports.getQuestionMappings = getQuestionMappings;
...
// ========== EXPORT MAPPINGS ==========
exports.QUESTION_MAPPINGS = {
    YLA: YLA_MAPPINGS,
    TASO2: TASO2_MAPPINGS,
    NUORI: NUORI_MAPPINGS
};
function getQuestionMappings(cohort, setIndex) {
    ...
    return exports.QUESTION_MAPPINGS[cohort];
}
