...
function getCareerConnectionText(subdimension: string, score: number, cohort: Cohort): string | null {
  ...
  const connections: Record<string, string> = {
    technology: `${scoreText.charAt(0).toUpperCase() + scoreText.slice(1)} teknologiakiinnostuksesi yhdistettynä ongelmanratkaisutaitoihisi tekee sinusta erinomaisen kandidaatin IT-alalle. Voisit työskennellä esimerkiksi ohjelmistokehittäjänä, data-analyytikkona, pelinkehittäjänä tai kyberturvallisuusasiantuntijana. Päivittäinen työsi sisältäisi koodaamista, järjestelmien suunnittelua tai digitaalisten ratkaisujen kehittämistä. IT-ala on voimakkaasti kasvava, työllistyminen on erinomaista, ja etätyömahdollisuudet tekevät alasta joustavan.`,
    people: `Koska välität ihmisistä ja nautit vuorovaikutuksesta, ehdotamme ammatteja, joissa pääset auttamaan ja kohtaamaan ihmisiä päivittäin. Voisit toimia esimerkiksi opettajana, hoitajana, sosiaalityöntekijänä tai HR-asiantuntijana. Työhösi kuuluisi ihmisten tukemista, kuuntelemista ja heidän hyvinvointinsa edistämistä. Nämä ammatit tarjoavat syvällistä merkityksellisyyttä ja mahdollisuuden tehdä oikeaa vaikutusta ihmisten elämään.`,
    health: `Kiinnostuksesi terveyttä ja hyvinvointia kohtaan ohjaa ehdotuksiamme kohti hoitoalaa ja terveyspalveluita. Voisit työskennellä sairaanhoitajana, lähihoitajana, fysioterapeuttina tai ravitsemusterapeutina. Päivittäin pääsisit auttamaan ihmisiä parantumaan ja voimaan paremmin. Terveysala tarjoaa varman työpaikan, sillä ammattilaisista on jatkuvaa kysyntää, ja työ on erittäin merkityksellistä.`,
    creative: `Luovuutesi näkyy vastauksissa, joten ehdotamme ammatteja, joissa pääset ilmaisemaan itseäsi ja suunnittelemaan uutta. Voisit työskennellä graafisena suunnittelijana, sisustusarkkitehtina, valokuvaajana tai markkinoinnin luovana osaajana. Työssäsi pääsisit ideoimaan, suunnittelemaan ja toteuttamaan visuaalisia tai konseptuaalisia ratkaisuja. Luovat alat tarjoavat vaihtelua, vapautta ja mahdollisuuden nähdä oma kädenjälkesi lopputuloksissa.`,
    leadership: `Johtamishalusi takia ehdotamme ammatteja, joissa voit ottaa vastuuta ja ohjata muita kohti tavoitteita. Voisit toimia esimerkiksi projektijohtajana, tiimiesihenkilönä, yrittäjänä tai osastonjohtajana. Päivittäin tekisit päätöksiä, koordinoisit tiimejä, ratkoisit haasteita ja motivoisit ihmisiä. Johtotehtävät tarjoavat mahdollisuuden vaikuttaa laajasti ja kehittyä urallasi kohti vastuullisempia tehtäviä.`,
    sports: `Urheilukiinnostuksesi ohjaa ehdotuksia valmennus- ja liikunta-alalle. Voisit työskennellä personal trainerina, urheiluvalmentajana, liikunnanohjaajana tai fysioterapeutissa. Päivittäin pääsisit auttamaan ihmisiä saavuttamaan terveyttä ja liikunnallisia tavoitteitaan. Liikunta-ala on kasvava, kun ihmiset arvostavat terveyttä yhä enemmän, ja työ yhdistää intohimosi liikuntaan merkitykselliseen ammattiin.`,
    teaching: `Halusi opettaa ja selittää asioita näkyy vastauksistasi, joten ehdotamme opetus- ja valmennustehtäviä. Voisit toimia opettajana, kouluttajana, tutorina tai mentorina. Työhösi kuuluisi tiedon jakamista, oppimisen tukemista ja ihmisten kehittämistä. Opettaminen tarjoaa syvää merkityksellisyyttä, kun näet oppilaittesi kehittyvän ja menestyvän, ja ammattina se on arvostettu yhteiskunnassa.`,
    hands_on: `Nautit käytännön tekemisestä, joten ehdotamme ammatteja, joissa näet työsi tulokset konkreettisesti. Voisit työskennellä rakennusalalla, sähköasentajana, puuseppänä, mekaanikona tai leipurina. Päivittäin rakennat, korjaat tai luot jotain käsilläsi ja näet oman työsi jäljen. Käytännön ammatit tarjoavat konkreettisuutta, vaihtelua ja mahdollisuuden kehittyä todelliseksi ammattilaiseksi käden taidoissasi.`,
    analytical: `Analyyttinen otteesi sopii ammatteihin, joissa ratkotaan ongelmia ja analysoidaan tietoa. Voisit toimia data-analyytikkona, tutkijana, talousanalyytikkona tai konsulttina. Työhösi kuuluisi tiedon keräämistä, mallintamista, trendien tunnistamista ja suositusten tekemistä. Analyyttiset roolit ovat kysyttyjä, palkat ovat kilpailukykyisiä, ja saat hyödyntää logiikkaa ja ongelmanratkaisukykyäsi päivittäin.`,
    environment: `Ympäristökiinnostuksesi takia ehdotamme töitä, joissa voit edistää kestävää kehitystä. Voisit työskennellä ympäristöinsinöörinä, kestävyyskonsulttina, maaseutuelinkeinojen parissa tai ympäristöjärjestössä. Päivittäin tekisit työtä planeetan hyväksi ja edistäisit ympäristöystävällisiä ratkaisuja. Ympäristöala on kasvava tulevaisuuden ala, jossa työllistyminen paranee koko ajan, kun kestävyys nousee yhteiskunnan prioriteetiksi.`,
    writing: `Ilmaisutaitosi takia ehdotamme ammatteja, joissa kirjoittaminen ja viestintä ovat keskeisiä. Voisit toimia toimittajana, sisällöntuottajana, copywriterina tai viestintäasiantuntijana. Päivittäin kirjoittaisit artikkeleita, luot sisältöjä tai viestisit brändin puolesta. Kirjoittamisen ammateissa pääset käyttämään luovuuttasi, vaikuttamaan ihmisiin ja kertomaan tarinoita monipuolisissa kanavissa.`,
    business: `Liiketoimintakiinnostuksesi ohjaa ehdotuksia yrittäjyyden ja kaupan alalle. Voisit perustaa oman yrityksen, toimia myyntipäällikkönä, liiketoimintakonsulttina tai talousjohtajana. Työhösi kuuluisi strategista suunnittelua, kasvun tavoittelua, neuvotteluita ja taloudellista päätöksentekoa. Liiketoimintaroolit tarjoavat mahdollisuuden vaikuttaa tuloksiin, kehittyä urallasi ja ansaita hyvin tulospohjaisten palkkioiden kautta.`
  };
