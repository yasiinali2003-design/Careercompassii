...
const FUTURE_ADVICE = {
  YLA: [
    "Kun mietit tulevaisuuden valintoja, kannattaa etsiä oppilaitoksia ja aloja, joissa pääset hyödyntämään näitä vahvuuksia. Tulevaisuudessa voit kehittää niitä entisestään valitsemalla sopivat opinnot, harrastukset ja ensimmäiset työtehtävät. Älä rajoita itseäsi liikaa, vaan kokeile rohkeasti erilaisia asioita ja katso, mihin vahvuutesi vievät sinut. Tämä on etsimisen ja kokeilun aikaa, ja jokainen kokemus opettaa sinulle jotain uutta itsestäsi.",
    "Näiden vahvuuksien pohjalta voit rakentaa mielenkiintoisen urapolun, joka tuntuu aidosti omalta. Kannattaa pitää mielessä, että polkuja on monia, ja voit yhdistää kiinnostuksen kohteesi luovasti tulevaisuudessa. Ei ole yhtä oikeaa tietä, vaan monia hyviä vaihtoehtoja, ja sinun tehtäväsi on löytää se, joka sopii juuri sinulle parhaiten. Ole avoin uusille mahdollisuuksille ja luota omaan arviointikykyysi.",
    "On hienoa, että olet jo nyt tutustumassa erilaisiin ammattimahdollisuuksiin ja omiin vahvuuksiisi. Tämä itsetuntemus auttaa sinua tekemään valintoja, jotka vievät sinua kohti uraa, joka tuntuu oikealta. Muista, että opinto- ja uravalinnat eivät ole lopullisia päätöksiä. Voit aina suunnata uudelleen, jos jokin alkaa tuntua väärältä. Tärkeintä on, että aloitat jostain ja opit matkalla."
  ],
  TASO2: [
