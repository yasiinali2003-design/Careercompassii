          ...
          <div className="max-w-4xl mx-auto text-center mb-20">
            <div className="inline-block mb-6">
              <div className="flex items-center justify-center gap-3 mb-4">
                <div className="h-1 w-16 bg-gradient-to-r from-transparent via-secondary to-secondary rounded-full"></div>
                <span className="text-sm font-bold text-secondary uppercase tracking-[0.15em] px-4 py-2 bg-secondary/10 rounded-full">Ura-alueet</span>
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-slate-900 leading-tight">
              Tutustu laajaan urakirjastoomme
            </h2>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Selaa satoja ammatteja ja löydä sinua kiinnostavat alat.
            </p>
          </div>
