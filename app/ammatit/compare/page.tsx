          ...
          <div className="inline-block min-w-full">
            <div className="grid gap-6" style={{ gridTemplateColumns: `repeat(${comparisons.length + 1}, minmax(300px, 1fr))` }}>
              ...
              {comparisons.length < 5 && (
                <div className="space-y-4">
                  <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl shadow-sm border-2 border-dashed border-blue-300 p-6 flex items-center justify-center min-h-[200px]">
