...
Kysymysten ja vastausten satunnaistus, kohtuulliset käyttörajoitukset, IP‑tason väärinkäytösten tunnistus, lokit teknisenä todisteena, palvelinpuoliset algoritmi- ja datarakennesuojaukset.

## 7 Rikkomusten seuraamukset
7.1 Välittömät toimet: pääsyn rajoitus/esto, IP‑osoitteen jäädytys, käyttöoikeuden poisto, oikeudelliset toimet.
...
Suomen laki. Riidat ensisijaisesti neuvotteluin; jos sovintoa ei synny, Helsingin käräjäoikeus. Kuluttaja‑asiat: Kuluttajariitalautakunta tai Helsingin käräjäoikeus.
