...
const TEST_SCENARIOS = {
  YLA: [
    ...
    },
    {
      ...
      answers: [
        2, // Q0: Lukeminen (LOW)
        3, // Q1: Matematiikka (MEDIUM - technical but not academic)
        ...
        3, // Q6: Selvität kunnolla (MEDIUM - precision)
        5, // Q7: Oppia ammatin nopeasti (HIGH - vocational)
        ...
        4, // Q13: Selkeä suunnitelma (HIGH - career clarity)
        2, // Q14: Kokeilla monia (LOW)
        4, // Q15: Teknologia (HIGH - technical skills)
        2, // Q16: Auttaa ihmisiä (LOW)
        1, // Q17: Luova (VERY LOW - not creative)
        4, // Q18: Ulkona (HIGH - practical work)
        2, // Q19: Johtaa (LOW - not leadership)
        5, // Q20: Rakentaminen (HIGH - hands_on signal)
        1, // Q21: Auttaa sairaita (VERY LOW - not healthcare)
        2, // Q22: Myynti (LOW)
        3, // Q23: Ryhmä (MEDIUM)
        4, // Q24: Itsenäinen (HIGH - hands_on workers often independent)
        4, // Q25: Ulkona luonnossa (HIGH - outdoor work)
        5, // Q26: Rutiinit (HIGH - structure/precision)
        2, // Q27: Matkustaminen (LOW)
        2, // Q28: Uudet ihmiset (LOW)
        2  // Q29: Kotona tietokoneella (LOW - not desk work)
      ],
      expectedCategory: "JARJESTAJA",  // YLA scoring identifies structured/organized practical work as JARJESTAJA
      expectedCareers: ["jarjestaja"] // Should contain organizational careers
    },
    {
  ...
  TASO2: [
    ...
    },
    {
      ...
      answers: [
        2, // Q0: Koodaaminen (LOW - not tech-focused)
        3, // Q1: Teknologia (MEDIUM - some digital skills)
        5, // Q2: Numerot, tilastot (HIGH - business analytics)
        3, // Q3: Tekniset ongelmat (MEDIUM - problem-solving)
        2, // Q4: Verkkosivut (LOW - not web dev)
        1, // Q5: Videopelit (VERY LOW - not gaming)
        2, // Q6: Tietoturva (LOW - not cybersecurity)
        2, // Q7: Auttaa ihmisiä (LOW - not healthcare-focused!)
        2, // Q8: Ihmisen mieli (LOW - not psychology!)
        3, // Q9: Opettaa (MEDIUM - some training/mentoring)
        2, // Q10: Tukea (LOW - not counseling!)
        1, // Q11: Lasten kanssa (VERY LOW - not childcare!)
        1, // Q12: Vanhukset (VERY LOW - not eldercare!)
        3, // Q13: Hyviä valintoja (MEDIUM - business consulting)
        4, // Q14: Grafiikka (HIGH - marketing/branding)
        5, // Q15: Mainonta (HIGH - business/marketing!)
        3, // Q16: Sisustus (MEDIUM - some design sense)
        4, // Q17: Kirjoittaminen (HIGH - business communication)
        3, // Q18: Valokuvaus (MEDIUM - marketing content)
        ...
        2, // Q24: Kasvit (LOW - not agriculture)
        3, // Q25: Ympäristö (MEDIUM - CSR awareness)
        2, // Q26: Kuljettaa (LOW - not transportation)
        3, // Q27: Ruoka (MEDIUM - business interest)
        2, // Q28: Käsityöt (LOW - not crafts)
        3  // Q29: Laboratorio (MEDIUM - research/data)
      ],
