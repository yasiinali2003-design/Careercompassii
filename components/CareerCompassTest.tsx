...
const QUESTIONS = {
  YLA: [
    "Pidätkö ryhmätyöskentelystä muiden kanssa?",
    "Kiinnostaako sinua teknologia ja digitaaliset ratkaisut?",
    "Haluaisitko johtaa muita ja tehdä päätöksiä?",
    "Pidätkö käytännön tekemisestä ja konkreettisista tehtävistä?",
    "Haluatko auttaa muita ihmisiä?",
    "Kiinnostaako sinua ympäristönsuojelu?",
    "Pidätkö pitkän tähtäimen suunnittelusta ja strategisesta ajattelusta?",
    "Oletko hyvä organisoimaan asioita ja tekemään aikatauluja?",
    "Pidätkö luovasta ilmaisusta ja taiteesta?",
    "Kiinnostaako sinua matematiikka ja tieteet?",
    "Haluatko tehdä konkreettista työtä käsilläsi?",
    "Pidätkö suunnittelusta ja asioiden järjestämisestä?",
    "Kiinnostaako sinua kirjoittaminen ja kielet?",
    "Kiinnostaako sinua visuaalinen suunnittelu ja grafiikka?",
    "Haluatko oppia uusia taitoja jatkuvasti?",
    "Pidätkö esiintymisestä ja esittämisestä muiden edessä?",
    "Kiinnostaako sinua historia ja kulttuuri?",
    "Haluatko työskennellä ulkona ja luonnossa?",
    "Pidätkö neuvottelemisesta ja myymisestä?",
    "Pidätkö tarkasta ja järjestelmällisestä työstä?",
    "Kiinnostaako sinua liiketoiminta ja talous?",
    "Haluatko kehittää uusia innovaatioita ja ideoita?",
    "Pidätkö muiden motivoimisesta ja kannustamisesta?",
    "Kiinnostaako sinua terveys ja hyvinvointi?",
    "Pidätkö tutkimisesta ja asioiden analysoinnista?",
    "Haluatko vaikuttaa yhteiskuntaan ja ihmisten elämään?",
    "Kiinnostaako sinua urheilu ja liikunta?",
    "Pidätkö ongelmien ratkaisemisesta?",
    "Pidätkö opettamisesta ja muiden valmentamisesta?",
    "Haluatko työskennellä kansainvälisesti?"
  ],
  TASO2: [
    "Pidätkö tiimityöskentelystä ja yhteistyöstä?",
    "Kiinnostaako sinua teknologia ja ohjelmointi?",
    "Haluaisitko johtaa projekteja ja tehdä päätöksiä?",
    "Pidätkö käytännön tekemisestä ja konkreettisista tehtävistä?",
    "Haluatko auttaa asiakkaita ja palvella muita?",
    "Kiinnostaako sinua kestävä kehitys ja ympäristöasiat?",
    "Pidätkö strategisesta ajattelusta ja pitkän tähtäimen suunnittelusta?",
    "Oletko hyvä projektinhallinnassa ja aikatauluttamisessa?",
    "Pidätkö luovasta suunnittelusta ja ideoinnista?",
    "Kiinnostaako sinua data-analyysi ja tilastot?",
    "Haluatko tehdä konkreettista ja näkyvää työtä?",
    "Pidätkö asioiden organisoimisesta ja suunnittelusta?",
    "Kiinnostaako sinua viestintä ja markkinointi?",
    "Kiinnostaako sinua graafinen suunnittelu ja visuaalisuus?",
    "Haluatko oppia uusia teknologioita jatkuvasti?",
    "Pidätkö esiintymisestä ja esittämisestä yleisön edessä?",
    "Kiinnostaako sinua kulttuuri ja taide?",
    "Haluatko työskennellä luonnossa tai ulkona?",
    "Pidätkö myymisestä ja neuvottelemisesta?",
    "Pidätkö tarkasta ja järjestelmällisestä työstä?",
    "Kiinnostaako sinua liiketoiminta ja strateginen ajattelu?",
    "Haluatko kehittää uusia ratkaisuja ja innovaatioita?",
    "Pidätkö muiden motivoimisesta ja johtamisesta?",
    "Kiinnostaako sinua terveys ja hyvinvointi?",
    "Pidätkö tutkimisesta ja asioiden analysoinnista?",
    "Haluatko vaikuttaa yhteiskuntaan ja ihmisten elämään?",
    "Kiinnostaako sinua urheilu ja liikunta?",
    "Pidätkö monimutkaisten ongelmien ratkaisemisesta?",
    "Pidätkö opettamisesta ja muiden kehittämisestä?",
    "Haluatko työskennellä kansainvälisessä ympäristössä?"
  ],
  NUORI: [
    "Pidätkö itsenäisestä työskentelystä?",
    "Kiinnostaako sinua teknologia ja digitalisaatio?",
    "Haluaisitko johtaa muita ja ottaa vastuuta?",
    "Pidätkö käytännön tekemisestä ja konkreettisista tehtävistä?",
    "Haluatko auttaa asiakkaita ja yhteisöä?",
    "Kiinnostaako sinua ympäristö ja kestävyys?",
    "Pidätkö strategisesta ajattelusta ja pitkän tähtäimen suunnittelusta?",
    "Oletko hyvä projektinhallinnassa ja organisoinnissa?",
    "Pidätkö luovasta ongelmanratkaisusta ja innovoinnista?",
    "Kiinnostaako sinua data-analyysi ja analytiikka?",
    "Haluatko tehdä konkreettista ja näkyvää työtä?",
    "Pidätkö asioiden suunnittelusta ja järjestämisestä?",
    "Kiinnostaako sinua viestintä ja markkinointi?",
    "Kiinnostaako sinua visuaalinen suunnittelu ja grafiikka?",
    "Haluatko oppia uusia teknologioita ja menetelmiä jatkuvasti?",
    ...
    "Pidätkö tarkasta ja järjestelmällisestä työstä?",
    "Kiinnostaako sinua liiketoiminta ja strateginen ajattelu?",
    "Haluatko kehittää uusia innovaatioita ja ratkaisuja?",
    "Pidätkö muiden motivoimisesta ja johtamisesta?",
    "Kiinnostaako sinua terveys ja hyvinvointi?",
    "Pidätkö tutkimisesta ja asioiden analysoinnista?",
