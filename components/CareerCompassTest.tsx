...
const QUESTIONS = {
  YLA: [
    ...
    "Oletko hyvä muistamaan asioita ja selityksiä?",
    "Tykkäätkö enemmän tekemällä oppimisesta kuin kuuntelemisesta?",
    ...
    "Kuinka paljon haluat pitää eri vaihtoehdot avoinna tulevaisuutta varten?",
    "Kiinnostaako sinua opiskella yliopistossa tulevaisuudessa?",
