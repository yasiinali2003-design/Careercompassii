    ...
    >
      <div className="container mx-auto px-4 py-4 flex items-center justify-between relative z-10">
        ...
        <div className="flex items-center gap-4 md:gap-8">
          ...
          <Button
            asChild
            className="bg-urak-accent-blue hover:bg-urak-accent-blue/90 text-urak-bg font-medium px-3 md:px-6 h-8 md:h-10 text-xs md:text-sm rounded-full transition-all duration-300 hover:scale-110 shadow-lg hover:shadow-2xl hover:-translate-y-0.5"
          >
